...
export const SU_TOOLBOXPRESEN_LAYOUTIMPORTBUTTON_CLICK = 'SU_TOOLBOXPRESEN_LAYOUTIMPORTBUTTON_CLICK';
...
export const SU_ToolBoxPresen_LayoutImportButton_Click = (payload = {}) => {
    return {
        type: SU_TOOLBOXPRESEN_LAYOUTIMPORTBUTTON_CLICK,
        payload: {
            json: payload.json,
        },
    };
